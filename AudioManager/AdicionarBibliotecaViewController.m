...
-(void)alertaNomeVazio{
    
    UIAlertView *av = [[UIAlertView alloc] initWithTitle:@"Empty name"
                                                 message:@"The name of collection can't be empty."
                                                delegate:self
...
{
    if (self.labelNome.text.length == 0) {
        [self alertaNomeVazio];
    }else{
